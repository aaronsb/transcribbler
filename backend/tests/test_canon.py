...
def test_third_person_naming_is_accepted():
    ...
    data = {
        "speaker_map": [{"id": "S1", "display_name": "Bob", "confidence": 0.8, "evidence": "thanks Bob"}],
        "term_map": [],
    }
    out = apply_canonicalization(ir, data)
...
def test_unsupported_evidence_is_rejected():
    ...
    data = {
        "speaker_map": [
            {"id": "S1", "display_name": "Dolores", "confidence": 0.99, "evidence": "my name is Dolores"}
        ],
        "term_map": [],
    }
    out = apply_canonicalization(ir, data)
...
def test_low_confidence_is_rejected():
    ...
    data = {
        "speaker_map": [
            {"id": "S1", "display_name": "Alan Watts", "confidence": 0.2, "evidence": "I am Alan Watts"}
        ],
        "term_map": [],
    }
...
def test_empty_name_leaves_speaker_as_fallback():
    ...
    data = {
        "speaker_map": [{"id": "S1", "display_name": "", "confidence": 0.0, "evidence": "x"}],
        "term_map": [],
    }
    assert out_unchanged(apply_canonicalization(ir, data))
